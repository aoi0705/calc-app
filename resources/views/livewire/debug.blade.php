<div>
<form class="needs-validation" action="form1.php" method="post">
    @csrf
<div class="form-group">
        ...
        <div class="form-group">
           ...
           <input type="text" id="post-number" name="post-number" class="form-control" wire:model.lazy="postnumber"><br>
           @error('postnumber')
                <p class="error">{{ $message }}</p>
            @enderror
        </div>
        ...
        <div class="form-group">
            ...
            <select id="job" name="job" class="form-control" wire:model.lazy="hisuonly">
        ...
        <div class="form-group">
           ...
           <input type="text" id="spouse-birthday" name="spouse-birthday" class="form-control" wire:model.lazy="birth"><br>
           @error('birth')
                <p class="error">{{ $message }}</p>
            @enderror
        </div>
        ...
        <div class="form-group">
           <label for="inputState">配偶者・パートナーの職業を教えてください</label>
            <select id="spouse-job" name="spouse-job" class="form-control" wire:model.lazy="hisuonly">
                <option selected></option>
                <option value="employee">会社員</option>
                <option value="housewife">主婦</option>
            </select>
        ...
        <div class="form-group">
           ...
           <select id="number-children" name="number-childre" class="form-control" wire:model.lazy="hisuonly">
                <option selected></option>
        ...
        <div class="form-group">
           ...
           <input type="text" id="first-birthday" name="first-birthday" class="form-control" wire:model.lazy="birth"><br>
            @error('birth')
                <p class="error">{{ $message }}</p>
            @enderror
        </div>
        ...
        <div class="form-group">
           <label for="text">2人目の生年月日<br>
                （今後、ご出産予定の場合は、想定時期を入力してください。）</label><br>
           <input type="second-birthday" id="second-birthday" class="form-control" wire:model.lazy="birth"><br>
            @error('birth')
                <p class="error">{{ $message }}</p>
            @enderror
        </div>
        ...
        <div class="form-group">
           <label for="text">3人目の生年月日<br>
                （今後、ご出産予定の場合は、想定時期を入力してください。）</label><br>
           <input type="text" id="third-birthday" class="third-birthday" wire:model.lazy="birth"><br>
            @error('birth')
                <p class="error">{{ $message }}</p>
            @enderror
        </div>
